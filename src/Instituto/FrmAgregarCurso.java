...
public class FrmAgregarCurso extends javax.swing.JFrame {
    ...
    private void cargarDocentes(){
        ...
        for(int i =0; i<cantidad;i++){
            modelo.addElement(GestionInstituto.listaDocentes.get(i));            
        }
    }
    /**
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (!txtCodigo.getText().isEmpty() && !txtNombreCurso.getText().isEmpty() 
            ...
            try{
                    ...
                    boolean existeCurso = GestionInstituto.existeCurso(codigoCurso);
                    if(!existeCurso){
                        ...
                        GestionInstituto.agregarCurso(unCurso);
