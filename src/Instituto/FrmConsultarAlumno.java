...
public class FrmConsultarAlumno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConsultar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/colegio/Images/search.png"))); // NOI18N
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (!txtIdentificacion.getText().isEmpty()){
            try{
                ...
                Alumno unAlumno = GestionInstituto.obtenerAlumnoPorIdentificacion(txtIdentificacion.getText().trim());
                if(unAlumno!=null){
